	...
	<div id="contents">
		<div class="clearfix">
			...
			<div>
				...
				<p>
					Healthkeeper helps track your medications so that you never miss a dose again. We will notify you when you need a refill, when it's time to take your meds, and tracks usage <span><br><br><a href="manage.php" class="btn">Start Tracking!</a><br><b>Don’t worry it’s for free</b></span>
				</p>
			</div>
		</div>
	</div>
